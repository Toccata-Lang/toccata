...
REG_TESTS = test1 test2 test3 test4 test5 test6 test7 test8 test9 test10 test11 test12 test13 \
        ...
        free-static-value tail-cond-1 test-inline-namespaced-sym test-closures string-regressions vector-regressions
...
sidequest: sidequest.c $(TEST_SOURCES)
	...
	rm graphs/*.svg || rm graphs/*.dot || ./sidequest || dot -Tsvg graphs.dot > graphs.svg
