...
REG_TESTS = test1 test2 test3 test4 test5 test6 test7 test8 test9 test10 test11 test12 test13 \
	...
	vector-regressions test-either test-comment-in-let test-recursive-map-fn test-tail-recur-1 test-tail-recur-3 test-trailing-comment test-underscore-inline # test-closures
