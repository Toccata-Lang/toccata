...
TESTS = test1 test2 test3 test4 test5 test6 test7 test8 test9 test10 test11 test12 test13 \
        ...
        free-static-value tail-cond-1 test-inline-namespaced-sym vector-regressions
TEST_SOURCES = new.c runtime3.c

new-toc: compiler.toc base.toc typer.toc codegen.toc
	...
	$(CC) -DCHECK_MEM_LEAK=1 -o new-toc -std=c99 core.c new-toc.c $(LDFLAGS)
