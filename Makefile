...
REG_TESTS = test1 test2 test3 test4 test5 test6 test7 test8 test9 test10 test11 test12 test13 \
	...
	test-ignore-inferred cond-expr-1 cond-expr-2 cond-expr-3 cond-expr-4 test-closures \
	free-static-value tail-cond-1 test-inline-namespaced-sym  string-regressions vector-regressions
